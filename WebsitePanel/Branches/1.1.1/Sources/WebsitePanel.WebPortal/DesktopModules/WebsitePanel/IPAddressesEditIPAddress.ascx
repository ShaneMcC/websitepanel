<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IPAddressesEditIPAddress.ascx.cs" Inherits="WebsitePanel.Portal.IPAddressesEditIPAddress" %>
...
<div class="FormBody">
    ...
    <table cellspacing="0" cellpadding="3">
	    ...
	    <tr id="ExternalRow" runat="server">
		    ...
		    <td>
		        <wsp:EditIPAddressControl id="externalIP" runat="server" ValidationGroup="EditAddress" Required="true" />
		    </td>
	    </tr>
