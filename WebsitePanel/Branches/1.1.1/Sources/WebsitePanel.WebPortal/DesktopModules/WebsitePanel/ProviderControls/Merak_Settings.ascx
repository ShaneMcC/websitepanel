<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Merak_Settings.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.Merak_Settings" %>
...
<table cellpadding="7" cellspacing="0" width="100%">
	...
	<tr>
		...
		<td width="100%">
            <asp:DropDownList runat="server" id="ddlAccountType" cssclass="NormalTextBox">
