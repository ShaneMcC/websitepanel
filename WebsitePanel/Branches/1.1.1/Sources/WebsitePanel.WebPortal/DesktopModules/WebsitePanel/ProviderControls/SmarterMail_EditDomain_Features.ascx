<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail_EditDomain_Features.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail_EditDomain_Features" %>
<table width="100%">
    <tr>
