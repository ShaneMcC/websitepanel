<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentMethodOffline.ascx.cs" Inherits="WebsitePanel.Ecommerce.Portal.PaymentMethodOffline" %>
<%@ Register TagPrefix="wsp" TagName="PluginProperties" Src="SupportedPlugins/OfflinePayment_Settings.ascx" %>
<div class="FormBody">
	<table>
		<tr>
			...
			<td>
				<asp:TextBox runat="server" ID="txtDisplayName" CssClass="NormalTextBox" MaxLength="50" 
					Width="150px" Text="Offline Payment" />&nbsp;
