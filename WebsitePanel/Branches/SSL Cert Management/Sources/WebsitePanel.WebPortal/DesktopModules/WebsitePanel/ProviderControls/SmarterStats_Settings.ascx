<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterStats_Settings.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterStats_Settings" %>
...
<table cellpadding="4" cellspacing="0" width="100%">
	<tr>
		...
		<td width="100%"><asp:TextBox Runat="server" ID="txtSmarterUrl" CssClass="NormalTextBox" Width="200px"></asp:TextBox></td>
	</tr>
	<tr>
		<td class="SubHead">
		    <asp:Label ID="lblUsername" runat="server" meta:resourcekey="lblUsername" Text="Admin Username:"></asp:Label>
		</td>
		<td><asp:TextBox Runat="server" ID="txtUsername" CssClass="NormalTextBox" Width="100px"></asp:TextBox></td>
	</tr>
	<tr>
		<td class="SubHead">
		    <asp:Label ID="lblPassword" runat="server" meta:resourcekey="lblPassword" Text="Admin Password:"></asp:Label>
		</td>
		<td><asp:TextBox Runat="server" ID="txtPassword" CssClass="NormalTextBox" TextMode="Password" Width="100px"></asp:TextBox></td>
	</tr>
	<tr>
		<td class="SubHead">
		...
		<td>
            <asp:DropDownList ID="ddlServers" runat="server" CssClass="NormalTextBox" DataTextField="Name" DataValueField="ServerId">
            </asp:DropDownList>
        </td>
	</tr>
	<tr>
		...
		<td>
            <asp:DropDownList ID="ddlLogFormat" runat="server" CssClass="NormalTextBox">
	...
	<tr>
		...
		<td><asp:TextBox Runat="server" ID="txtLogWilcard" CssClass="NormalTextBox"></asp:TextBox></td>
	</tr>
	<tr>
		<td class="SubHead">
		...
		<td class="Normal">
		    <asp:TextBox Runat="server" ID="txtLogDeleteDays" CssClass="NormalTextBox" Width="40"></asp:TextBox>
	...
	<tr>
		...
		<td class="Normal">
		    <asp:TextBox Runat="server" ID="txtSmarterLogs" CssClass="NormalTextBox"></asp:TextBox>
		</td>
	</tr>
	<tr>
		<td class="SubHead">
		...
		<td class="Normal">
		    <asp:TextBox Runat="server" ID="txtSmarterLogDeleteMonths" CssClass="NormalTextBox" Width="40"></asp:TextBox>
	...
	<tr>
		...
		<td><asp:TextBox Runat="server" ID="txtStatsUrl" CssClass="NormalTextBox" Width="100%"></asp:TextBox></td>
	</tr>
</table>