<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NotificationPaymentReceived.ascx.cs" Inherits="WebsitePanel.Ecommerce.Portal.NotificationPaymentReceived" %>
<%@ Register TagPrefix="wsp" TagName="NotificationEditor" Src="UserControls/EmailNotificationEditor.ascx" %>

<div class="FormButtonsBar">
	<div class="FormSectionHeader"><asp:Localize runat="server" meta:resourcekey="lclPaymentReceived" /></div>
</div>
<div class="FormBody">
