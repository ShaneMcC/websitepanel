        ...
        <fieldset>
            ...
            <fieldset>
                ...
                <div class="pnlControl">
                    ...
                    <asp:Button ID="btnSCVMMServer" runat="server" CssClass="disabled" meta:resourcekey="btnSCVMMServer" CausesValidation="false"
            ...
            <fieldset>
                ...
                <div class="pnlControl">
                    ...
                    <asp:Button ID="btnSCOMServer" runat="server" CssClass="disabled" meta:resourcekey="btnSCOMServer" CausesValidation="false" 
