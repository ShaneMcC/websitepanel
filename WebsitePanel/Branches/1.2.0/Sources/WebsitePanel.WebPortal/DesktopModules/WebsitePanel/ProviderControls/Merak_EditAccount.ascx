<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Merak_EditAccount.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.Merak_EditAccount" %>
<%@ Register TagPrefix="wsp" TagName="CollapsiblePanel" Src="../UserControls/CollapsiblePanel.ascx" %>


<wsp:CollapsiblePanel id="secUserSettings" runat="server"
...
<tr>
        ...
        <td class="normal" width="100%">
            <asp:TextBox ID="txtName" runat="server" Width="200px" CssClass="NormalTextBox"></asp:TextBox>
        </td>
</tr>
</table>
</asp:Panel> 
