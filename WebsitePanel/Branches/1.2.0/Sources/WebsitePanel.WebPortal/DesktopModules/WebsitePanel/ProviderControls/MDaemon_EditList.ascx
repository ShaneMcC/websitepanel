<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MDaemon_EditList.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.MDaemon_EditList" %>
...
<table cellSpacing="0" cellPadding="3" width="100%">
	...
	<tr>
		...
		<td class="normal">
			<asp:DropDownList id="ddlPostingMode" runat="server" meta:resourcekey="ddlPostingMode" CssClass="NormalTextBox" Width="150px">
	...
	<tr>
		...
		<td class="normal">
			<asp:TextBox id="txtPassword" runat="server" TextMode="Password" CssClass="NormalTextBox" Width="150px"></asp:TextBox>
		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td class="normal">
			<asp:TextBox id="txtModeratorEmail" runat="server" Width="150px" CssClass="NormalTextBox"></asp:TextBox>
		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
