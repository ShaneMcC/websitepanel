<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SimpleDNS_Settings.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SimpleDNS_Settings" %>
...
<fieldset>
	...
	<table cellpadding="1" cellspacing="0" width="100%">
			...
			<tr>
				...
				<td class="Normal"><asp:textbox id="txtUrl" Width="200" CssClass="NormalTextBox" Runat="server"></asp:textbox></td>
			</tr>
			<tr>
				<td class="SubHead">
					<asp:Label ID="lblLogin" runat="server" meta:resourcekey="lblLogin" Text="Admin Login:"></asp:Label>
				</td>
				<td class="Normal"><asp:textbox id="txtLogin" Width="200" CssClass="NormalTextBox" 
			...
			<tr>
				...
				<td class="Normal"><asp:textbox id="txtPassword" Width="200" CssClass="NormalTextBox" Runat="server" TextMode="Password"></asp:textbox></td>
			</tr>
			<tr>
				<td class="SubHead">
