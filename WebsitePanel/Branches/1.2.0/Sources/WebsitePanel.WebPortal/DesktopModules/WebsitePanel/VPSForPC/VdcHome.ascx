...
--%>                            <asp:Button ID="btnFastCreate" runat="server" meta:resourcekey="btnFastCreate"
                                Text="Clone VM" CssClass="Button1" CausesValidation="False" 
                                onclick="btnFastCreate_Click"/>
                        </div>
