<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VpsDetailsAuditLog.ascx.cs" Inherits="WebsitePanel.Portal.VPSForPC.VpsDetailsAuditLog" %>
	    ...
	    <div class="Content">
		    <div class="Center">
			    ...
			    <div class="FormBody">
				    ...
				    <wsp:AuditLogControl id="auditLog" runat="server" LogSource="VPSForPC" />
