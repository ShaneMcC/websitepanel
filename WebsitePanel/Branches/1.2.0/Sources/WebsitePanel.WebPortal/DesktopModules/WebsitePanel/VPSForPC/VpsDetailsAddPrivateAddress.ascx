<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VpsDetailsAddPrivateAddress.ascx.cs" Inherits="WebsitePanel.Portal.VPSForPC.VpsDetailsAddPrivateAddress" %>
