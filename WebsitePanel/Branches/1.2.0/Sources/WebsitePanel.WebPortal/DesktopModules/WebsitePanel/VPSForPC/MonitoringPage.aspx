<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonitoringPage.aspx.cs" Inherits="WebsitePanel.Portal.VPSForPC.MonitoringPage" %>
    ...
    <form id="form1" runat="server" style="width:590px; height:700px">
        ...
        <div id="testClass" style="width:590px; height:700px">
            <table cellpadding="3" width="100%">
                    <tr>
                        <td >
                            <asp:Label ID="lblStartPeriod" runat="server" AssociatedControlID="txtStartPeriod" meta:resourcekey="lblStartPeriod"
                                Text="Start day" CssClass="MediumBold" />
                        </td>
                        <td>
			    ...
			    <asp:UpdatePanel runat="server" ID="UpdatePanelCharts" UpdateMode="Conditional">
                    ...
                    <ContentTemplate>                
                            <asp:Chart ID="ChartCounter" runat="server" ImageLocation="TempImages/ChartPic_#SEQ(300,3)" 
                                ...
                                <Series>
							        <asp:Series MarkerSize="8" BorderWidth="3" XValueType="DateTime" Name="series" 
                                        ChartType="StackedArea" MarkerStyle="Circle" ShadowColor="Black" 
                                        BorderColor="180, 26, 59, 105" Color="#33CC33" ShadowOffset="2" 
