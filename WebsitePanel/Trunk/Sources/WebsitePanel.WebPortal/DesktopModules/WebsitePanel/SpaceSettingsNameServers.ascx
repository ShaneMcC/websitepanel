<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SpaceSettingsNameServers.ascx.cs" Inherits="WebsitePanel.Portal.SpaceSettingsNameServers" %>
<%@ Register Src="UserControls/EditDomainsList.ascx" TagName="EditDomainsList" TagPrefix="uc1" %>
<%@ Register TagPrefix="wsp" TagName="CollapsiblePanel" Src="UserControls/CollapsiblePanel.ascx" %>

<wsp:CollapsiblePanel id="secNameServers" runat="server"
