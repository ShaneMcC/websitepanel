<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AbilityMailServer_EditList.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.AbilityMailServer_EditList" %>
