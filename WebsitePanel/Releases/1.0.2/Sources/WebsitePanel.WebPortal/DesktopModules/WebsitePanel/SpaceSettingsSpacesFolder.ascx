<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SpaceSettingsSpacesFolder.ascx.cs" Inherits="WebsitePanel.Portal.SpaceSettingsSpacesFolder" %>
<%@ Register TagPrefix="wsp" TagName="CollapsiblePanel" Src="UserControls/CollapsiblePanel.ascx" %>

<wsp:CollapsiblePanel id="tblSpacesFolder" runat="server"
    ...
    <table>
        <tr>
            ...
            <td class="Normal" width="100%" valign="top">
                <asp:TextBox ID="txtSpacesFolder" runat="server" CssClass="NormalTextBox" Width="250px"></asp:TextBox>
                <br />
