<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HostingAddonsAddAddon.ascx.cs" Inherits="WebsitePanel.Ecommerce.Portal.DesktopModules.Ecommerce.HostingAddonsAddAddon" %>
...
<div class="FormBody">
	<table cellspacing="0" cellpadding="3">
		...
		<tr>
			...
			<td>
				<asp:TextBox runat="server" ID="txtProductSku" Width="250px" CssClass="NormalTextBox" />
