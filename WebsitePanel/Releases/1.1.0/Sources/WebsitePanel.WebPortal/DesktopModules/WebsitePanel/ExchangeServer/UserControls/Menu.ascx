<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Menu.ascx.cs" Inherits="WebsitePanel.Portal.ExchangeServer.UserControls.Menu" %>
<div class="Menu">
	<asp:DataList ID="repMenu" runat="server" EnableViewState="false"
		...
		<ItemTemplate>			
			<div class="MenuGroup">				
				...
				<asp:DataList runat="server" ID="dlMenuItems" EnableViewState="false" RepeatDirection="Horizontal" RepeatLayout="Flow" DataSource='<%#Eval("MenuItems") %>' >
				    <ItemTemplate>
				        <div class="MenuItem">
