<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail60_EditList.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail60_EditList" %>
