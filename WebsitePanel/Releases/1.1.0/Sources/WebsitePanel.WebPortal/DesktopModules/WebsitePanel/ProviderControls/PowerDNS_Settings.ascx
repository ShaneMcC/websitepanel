<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PowerDNS_Settings.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.PowerDNS_Settings" %>
...
<fieldset>
	...
	<table cellspacing="0" width="100%">
		...
		<tr>
			...
			<td class="Normal">
				<asp:TextBox runat="server" ID="txtServerAddress" MaxLength="1000" CssClass="NormalTextBox"/>
		...
		<tr>
			...
			<td class="Normal">
				<asp:TextBox runat="server" ID="txtServerPort" MaxLength="1000" CssClass="NormalTextBox"/>
		...
		<tr>
			...
			<td class="Normal">
				<asp:TextBox runat="server" ID="txtDatabase" MaxLength="1000" CssClass="NormalTextBox"/>
		...
		<tr>
			...
			<td class="Normal">
				<asp:TextBox runat="server" ID="txtUsername" MaxLength="1000" CssClass="NormalTextBox"/>
		...
		<tr id="trPassword" runat="server">
			...
			<td class="Normal">
				<asp:TextBox runat="server" ID="txtPassword" MaxLength="1000" TextMode="Password" CssClass="NormalTextBox"/>
		...
		<tr id="trPasswordConfirm" runat="server">
			...
			<td class="Normal">
				<asp:TextBox runat="server" ID="txtConfirmPassword" MaxLength="1000" TextMode="Password" CssClass="NormalTextBox"/>                   
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="txtResponsiblePerson" runat="server" Width="300px" CssClass="NormalTextBox"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<td class="SubHead">
