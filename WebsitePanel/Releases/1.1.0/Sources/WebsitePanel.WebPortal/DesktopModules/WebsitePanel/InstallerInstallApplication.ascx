<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InstallerInstallApplication.ascx.cs" Inherits="WebsitePanel.Portal.InstallerInstallApplication" %>
...
<div class="FormBody">
	...
	<!-- location -->
    <wsp:CollapsiblePanel id="secLocation" runat="server"
	...
	<div id="divDatabase" runat="server">
        <wsp:CollapsiblePanel id="secDatabase" runat="server"
	...
	<div id="divSettings" runat="server">
	    <!-- app settings -->
        <wsp:CollapsiblePanel id="secAppSettings" runat="server"
