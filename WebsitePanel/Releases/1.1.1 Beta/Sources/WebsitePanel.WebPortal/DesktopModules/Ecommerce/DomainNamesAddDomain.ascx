<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DomainNamesAddDomain.ascx.cs" Inherits="WebsitePanel.Ecommerce.Portal.DomainNamesAddDomain" %>
...
<div class="FormBody">
	<table cellspacing="0" cellpadding="3">
		<tr>
			...
			<td>
				<asp:TextBox runat="server" ID="txtDomainTLD" CssClass="NormalTextBox" Width="150px" />
				<asp:RequiredFieldValidator runat="server" ErrorMessage="*" Display="Dynamic" 
					ControlToValidate="txtDomainTLD" />
				<asp:RegularExpressionValidator runat="server" meta:resourcekey="regexDomainTLD" 
					Display="Dynamic" ControlToValidate="txtDomainTLD" ValidationExpression="^\w{2,5}(\.?\w{2,})?$" />
			</td>
		</tr>
		<tr>
			<td>
...
<div class="FormFooter">
	<asp:Button id="btnCreateTLD" runat="server" meta:resourcekey="btnCreateTLD" 
		CssClass="Button1" OnClick="btnCreateTLD_Click" />&nbsp;
