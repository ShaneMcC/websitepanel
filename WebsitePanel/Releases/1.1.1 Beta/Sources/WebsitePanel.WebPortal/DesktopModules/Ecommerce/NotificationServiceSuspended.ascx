<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NotificationServiceSuspended.ascx.cs" Inherits="WebsitePanel.Ecommerce.Portal.NotificationServiceSuspended" %>
<%@ Register TagPrefix="wsp" TagName="NotificationEditor" Src="UserControls/EmailNotificationEditor.ascx" %>

<div class="FormButtonsBar">
	<div class="FormSectionHeader"><asp:Localize runat="server" meta:resourcekey="lclServiceSuspended" /></div>
</div>
<div class="FormBody">
