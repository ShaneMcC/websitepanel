<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HostedSoluitonReportSummaryLetter.ascx.cs" Inherits="WebsitePanel.Portal.HostedSoluitonReportSummaryLetter" %>
<table>
    <tr>
