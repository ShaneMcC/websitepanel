<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SettingsOrganizationUserSummaryLetter.ascx.cs" Inherits="WebsitePanel.Portal.SettingsOrganizationUserSummaryLetter" %>
<table>
    <tr>
