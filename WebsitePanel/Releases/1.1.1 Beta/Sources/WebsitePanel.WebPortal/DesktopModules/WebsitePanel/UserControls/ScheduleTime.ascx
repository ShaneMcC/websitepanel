<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScheduleTime.ascx.cs" Inherits="WebsitePanel.Portal.ScheduleTime" %>
<asp:TextBox ID="txtHours" runat="server" CssClass="NormalTextBox" Width="30px">12</asp:TextBox>
:
<asp:TextBox ID="txtMinutes" runat="server" CssClass="NormalTextBox" Width="30px">00</asp:TextBox>
