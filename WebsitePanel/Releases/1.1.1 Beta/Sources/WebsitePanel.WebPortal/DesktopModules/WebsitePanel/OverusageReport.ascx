<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OverusageReport.ascx.cs" Inherits="WebsitePanel.Portal.OverusageReport" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"
	Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
<%@ Register TagPrefix="wsp" TagName="CollapsiblePanel" Src="UserControls/CollapsiblePanel.ascx" %>
<%@ Register TagPrefix="wsp" TagName="CalendarControl" Src="UserControls/CalendarControl.ascx" %>
					...
					<td class="Normal" valign="top" width="150px">
						<table>
							<tr>
								...
								<td class="Normal">
									<wsp:CalendarControl ID="startDateCalendar" runat="server" />
								</td>
							</tr>
							...
							<tr>
								...
								<td class="Normal">
									<wsp:CalendarControl ID="endDateCalendar" runat="server" />
								</td>
							</tr>
						</table>
...
<div class="FormButtonsBar">
	<asp:Button
		ID="refreshButton" runat="server"
		Text="Refresh Report" meta:resourcekey="refreshButton"
