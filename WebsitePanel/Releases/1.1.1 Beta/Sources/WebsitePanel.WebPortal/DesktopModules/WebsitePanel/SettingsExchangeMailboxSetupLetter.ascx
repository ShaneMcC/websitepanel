<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SettingsExchangeMailboxSetupLetter.ascx.cs" Inherits="WebsitePanel.Portal.SettingsExchangeMailboxSetupLetter" %>
<table>
    <tr>
