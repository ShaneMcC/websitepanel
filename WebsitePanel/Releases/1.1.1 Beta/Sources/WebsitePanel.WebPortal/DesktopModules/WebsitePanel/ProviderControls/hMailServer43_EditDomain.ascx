<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="hMailServer43_EditDomain.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.hMailServer43_EditDomain" %>
<table width="100%">
    <tr>
