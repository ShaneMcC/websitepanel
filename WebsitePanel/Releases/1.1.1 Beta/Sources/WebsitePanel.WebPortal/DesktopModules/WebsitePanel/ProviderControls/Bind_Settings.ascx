<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Bind_Settings.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.Bind_Settings" %>
...
<table cellpadding="1" cellspacing="0" width="100%">
	    ...
	    <tr>
		    ...
		    <td class="Normal"><asp:textbox id="txtBindConfigPath" Width="200" CssClass="NormalTextBox" Runat="server"></asp:textbox></td>
	    </tr>
	    <tr>
		    <td class="SubHead">
		        <asp:Label ID="lblZonesFolderPath" runat="server" meta:resourcekey="lblZonesFolderPath" Text="Zone Files Folder:"></asp:Label>
		    </td>
		    <td class="Normal"><asp:textbox id="txtZonesFolderPath" Width="200" CssClass="NormalTextBox" Runat="server"></asp:textbox></td>
	    </tr>
	    <tr>
		    <td class="SubHead">
		    ...
		    <td class="Normal"><asp:textbox id="txtZoneFileNameTemplate" Width="200" CssClass="NormalTextBox" Runat="server"></asp:textbox></td>
	    </tr>
	    <tr>
		    <td class="SubHead">
		        <asp:Label ID="lblBindReloadBatch" runat="server" meta:resourcekey="lblBindReloadBatch" Text="Bind Reload Batch:"></asp:Label>
		    </td>
		    <td class="Normal"><asp:textbox id="txtBindReloadBatch" Width="200" CssClass="NormalTextBox" Runat="server"></asp:textbox></td>
	    </tr>
	    <tr>
		    <td class="SubHead">
