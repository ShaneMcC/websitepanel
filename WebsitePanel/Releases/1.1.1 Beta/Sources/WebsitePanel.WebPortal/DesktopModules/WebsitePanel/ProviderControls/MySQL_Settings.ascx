<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MySQL_Settings.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.MySQL_Settings" %>
<fieldset>
    <legend>
...
<fieldset>
	...
	<table cellpadding="4" cellspacing="0" width="100%">
		<tr>
			...
			<td width="100%"><asp:TextBox Width="200px" CssClass="NormalTextBox" Runat="server" ID="txtInternalAddress"></asp:TextBox></td>
		</tr>
		<tr>
			<td class="SubHead">
			...
			<td>
				<asp:TextBox Width="200px" CssClass="NormalTextBox" Runat="server" ID="txtExternalAddress"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<td class="SubHead">
			...
			<td><asp:TextBox Runat="server" ID="txtBinFolder" CssClass="NormalTextBox" Width="300px"></asp:TextBox></td>
		</tr>
		<tr>
			<td class="SubHead">
				<asp:Label ID="lblLogin" runat="server" meta:resourcekey="lblLogin" Text="Root Login:"></asp:Label>
			</td>
			<td><asp:TextBox Runat="server" ID="txtUserName" CssClass="NormalTextBox" Width="150px"></asp:TextBox></td>
		</tr>
		...
		<tr>
			...
			<td><asp:TextBox Runat="server" ID="txtPassword" CssClass="NormalTextBox" Width="150px" TextMode="Password"></asp:TextBox>
				</td>
		</tr>
		<tr>
			<td class="SubHead">
			...
			<td class="NormalBold"><asp:TextBox Runat="server" ID="txtConfirmPassword" CssClass="NormalTextBox" Width="150px" TextMode="Password"></asp:TextBox>
		...
		<tr>
			...
			<td>
				<asp:TextBox Width="400px" CssClass="NormalTextBox" Runat="server" ID="txtBrowseUrl"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<td class="SubHead">
			...
			<td>
				<asp:DropDownList ID="ddlBrowseMethod" runat="server" CssClass="NormalTextBox">
		...
		<tr>
			...
			<td>
				<asp:TextBox Width="200px" CssClass="NormalTextBox" Runat="server" TextMode="MultiLine" Rows="5" ID="txtBrowseParameters"></asp:TextBox>
			</td>
		</tr>
	</table>
</fieldset>