<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AbilityMailServer_EditAccount.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.AbilityMailServer_EditAccount" %>
