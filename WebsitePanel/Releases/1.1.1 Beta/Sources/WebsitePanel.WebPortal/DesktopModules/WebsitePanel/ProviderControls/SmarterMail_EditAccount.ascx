<%@ Control Language="C#" AutoEventWireup="true" Codebehind="SmarterMail_EditAccount.ascx.cs"
    Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail_EditAccount" %>
...
<table width="100%">
    <tr runat="server" id="passwordRow">
        ...
        <td class="SubHead">
            <asp:CheckBox runat="server" Checked="false"  meta:resourcekey="cbChangePassword" ID="cbChangePassword" Text="Change password" />
        </td>
    </tr> 
    <tr>
