<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail60_EditAccount.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail60_EditAccount" %>
