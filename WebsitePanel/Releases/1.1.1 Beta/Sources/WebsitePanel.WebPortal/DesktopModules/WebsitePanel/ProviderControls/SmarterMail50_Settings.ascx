<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail50_Settings.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail50_Settings" %>
...
<table cellpadding="7" cellspacing="0" width="100%">
	...
	<tr>
		...
		<td>
           <asp:DropDownList ID="ddlLicenseType" runat="server" CssClass="NormalTextBox">
