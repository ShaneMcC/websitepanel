<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Merak_EditList.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.Merak_EditList" %>
...
<table cellSpacing="0" cellPadding="3" width="100%">
	...
	<tr>
		...
		<td class="normal">
			<asp:DropDownList id="ddlPasswordProtection" runat="server" resourcekey="ddlPasswordProtection" CssClass="NormalTextBox" Width="150px">
	...
	<tr>
		...
		<td class="normal">
			<asp:TextBox id="txtPassword" runat="server" CssClass="NormalTextBox" Width="150px" TextMode = "Password"></asp:TextBox>
		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
