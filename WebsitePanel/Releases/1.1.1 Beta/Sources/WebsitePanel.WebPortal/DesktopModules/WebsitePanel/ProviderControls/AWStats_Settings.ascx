<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AWStats_Settings.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.AWStats_Settings" %>
<table cellpadding="4" cellspacing="0" width="100%">
	<tr>
		...
		<td width="100%"><asp:TextBox Runat="server" ID="txtAwStatsFolder" CssClass="NormalTextBox" Width="200px"></asp:TextBox></td>
	</tr>
	<tr>
		<td class="SubHead">
		    <asp:Label ID="lblBatchFileName" runat="server" meta:resourcekey="lblBatchFileName" Text="Batch File Name:"></asp:Label>
		</td>
		<td><asp:TextBox Runat="server" ID="txtBatchFileName" CssClass="NormalTextBox" Width="200px"></asp:TextBox></td>
	</tr>
	<tr>
		<td class="SubHead">
		    <asp:Label ID="lblLineTemplate" runat="server" meta:resourcekey="lblLineTemplate" Text="Batch File Line Template:"></asp:Label>
		</td>
		<td><asp:TextBox Runat="server" ID="txtBatchLineTemplate" CssClass="NormalTextBox" Width="100%"></asp:TextBox></td>
	</tr>
	<tr>
		...
		<td vAlign="top"><asp:TextBox Runat="server" ID="txtConfigFileName" CssClass="NormalTextBox" Width="200px"></asp:TextBox></td>
	</tr>
	<tr>
		...
		<td><asp:TextBox Runat="server" ID="txtConfigFileTemplate" CssClass="NormalTextBox" Width="100%"
	...
	<tr>
		...
		<td><asp:TextBox Runat="server" ID="txtConfigFileTemplatePath" CssClass="NormalTextBox" Width="100%"></asp:TextBox></td>
	</tr>
	<tr>
		<td class="SubHead">
