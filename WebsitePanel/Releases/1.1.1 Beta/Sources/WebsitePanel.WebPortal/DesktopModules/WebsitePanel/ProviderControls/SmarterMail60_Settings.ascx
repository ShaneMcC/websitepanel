<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail60_Settings.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail60_Settings" %>
