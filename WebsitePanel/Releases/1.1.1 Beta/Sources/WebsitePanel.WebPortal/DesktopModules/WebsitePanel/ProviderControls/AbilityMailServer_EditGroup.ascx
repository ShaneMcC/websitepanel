<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AbilityMailServer_EditGroup.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.AbilityMailServer_EditGroup" %>
