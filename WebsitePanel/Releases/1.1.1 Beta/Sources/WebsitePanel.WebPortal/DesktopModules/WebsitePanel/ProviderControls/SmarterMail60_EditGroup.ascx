<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail60_EditGroup.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail60_EditGroup" %>
