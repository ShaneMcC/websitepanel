<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CountrySelector.ascx.cs" Inherits="WebsitePanel.Portal.ExchangeServer.UserControls.CountrySelector" %>
<asp:DropDownList ID="ddlCountry" runat="server" CssClass="NormalTextBox">
