<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DiskspaceReport.ascx.cs" Inherits="WebsitePanel.Portal.DiskspaceReport" %>
...
<asp:ObjectDataSource ID="odsReport" runat="server" EnablePaging="True" SelectCountMethod="GetPackagesDiskspacePagedCount"
    SelectMethod="GetPackagesDiskspacePaged" SortParameterName="sortColumn" TypeName="WebsitePanel.Portal.ReportsHelper" OnSelected="odsReport_Selected">
    <SelectParameters>
