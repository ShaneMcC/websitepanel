<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SettingsMailPolicy.ascx.cs" Inherits="WebsitePanel.Portal.SettingsMailPolicy" %>
...
<asp:Panel ID="GeneralPanel" runat="server" Height="0" style="overflow:hidden;">
    <table>
        <tr>
            ...
            <td class="Normal">
                <asp:TextBox ID="txtCatchAll" runat="server" CssClass="NormalTextBox" Width="200"></asp:TextBox>
