<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SettingsOperatingSystemPolicy.ascx.cs" Inherits="WebsitePanel.Portal.SettingsOperatingSystemPolicy" %>
...
<wsp:CollapsiblePanel id="secOdbc" runat="server"
