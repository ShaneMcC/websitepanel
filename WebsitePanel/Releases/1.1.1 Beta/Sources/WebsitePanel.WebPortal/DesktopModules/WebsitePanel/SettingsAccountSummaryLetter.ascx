<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SettingsAccountSummaryLetter.ascx.cs" Inherits="WebsitePanel.Portal.SettingsAccountSummaryLetter" %>
<table>
    <tr>
    ...
    <tr>
        ...
        <td class="Normal" width="100%">
            <asp:TextBox ID="txtFrom" runat="server" Width="450px" CssClass="NormalTextBox"></asp:TextBox></td>
    </tr>
    <tr>
        <td class="SubHead"><asp:Label ID="lblCC" runat="server" meta:resourcekey="lblCC" Text="CC:"></asp:Label></td>
        <td class="Normal">
            <asp:TextBox ID="txtCC" runat="server" Width="450px" CssClass="NormalTextBox"></asp:TextBox></td>
    </tr>
    <tr>
        <td class="SubHead"><asp:Label ID="lblSubject" runat="server" meta:resourcekey="lblSubject" Text="Subject:"></asp:Label></td>
        <td class="Normal">
            <asp:TextBox ID="txtSubject" runat="server" Width="450px" CssClass="NormalTextBox"></asp:TextBox></td>
    </tr>
    <tr>
