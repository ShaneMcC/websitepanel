<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SharePointEditSite.ascx.cs" Inherits="WebsitePanel.Portal.SharePointEditSite" %>
...
<div class="FormFooter">
    <asp:Button ID="btnUpdate" runat="server" CssClass="Button1"
        Text="Update" OnClick="btnUpdate_Click" meta:resourcekey="btnUpdate" />
