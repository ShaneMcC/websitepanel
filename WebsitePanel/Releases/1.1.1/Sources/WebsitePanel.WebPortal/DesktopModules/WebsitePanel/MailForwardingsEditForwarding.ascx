<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MailForwardingsEditForwarding.ascx.cs" Inherits="WebsitePanel.Portal.MailForwardingsEditForwarding" %>
...
<div class="FormBody">
    ...
    <table cellSpacing="0" cellPadding="3" width="100%">
        <tr>
            <td class="SubHead" style="width:150px;"><asp:Label ID="lblForwardsToEmail" runat="server" meta:resourcekey="lblForwardsToEmail" Text="Forwards to e-mail:"></asp:Label></td>
            <td class="normal">
	            <asp:TextBox id="txtForwardTo" runat="server" CssClass="NormalTextBox" Width="150px"></asp:TextBox></td>
        </tr>
     </table>
...
<div class="FormFooter">
    <asp:Button ID="btnSave" runat="server" meta:resourcekey="btnSave" CssClass="Button1" Text="Save" OnClick="btnSave_Click" OnClientClick = "ShowProgressDialog('Saving Mail Alias...');"/>
