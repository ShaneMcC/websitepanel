<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SpaceDetailsHeaderControl.ascx.cs" Inherits="WebsitePanel.Portal.SpaceDetailsHeaderControl" %>
...
<table cellSpacing="0" cellPadding="5" width="100%">
	...
	<tr>
		...
		<td class="Normal">
			<wsp:UserDetails id="spaceUser" runat="server"/>
		</td>
	</tr>
	<tr>
