<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HostingPlansEditPlan.ascx.cs" Inherits="WebsitePanel.Ecommerce.Portal.HostingPlansEditPlan" %>
...
<div class="FormBody">
	<table cellspacing="0" cellpadding="3">
		...
		<tr runat="server" visible="false">
			<td>
				<asp:Localize id="Localize1" runat="server" meta:resourcekey="lclTaxInclusive" /></td>
			<td>
...
<div class="FormFooter">
	<asp:Button id="btnSavePlan" runat="server" meta:resourcekey="btnSavePlan" 
		CssClass="Button1" OnClick="btnSavePlan_Click" />&nbsp;
	<asp:Button id="btnDeletePlan" runat="server" meta:resourcekey="btnDeletePlan" 
		CssClass="Button1" OnClick="btnDeletePlan_Click" />&nbsp;
