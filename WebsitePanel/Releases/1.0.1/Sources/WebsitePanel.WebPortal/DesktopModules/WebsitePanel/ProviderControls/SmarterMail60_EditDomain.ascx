<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail60_EditDomain.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail60_EditDomain" %>
