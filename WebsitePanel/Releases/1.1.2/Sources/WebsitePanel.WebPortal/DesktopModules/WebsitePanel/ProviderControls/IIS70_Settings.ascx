...
<fieldset>
    <legend>
        <asp:Label ID="Label1" runat="server" meta:resourcekey="WDeployPublishingSettings" Text="Web Publishing Settings" CssClass="NormalBold"></asp:Label>&nbsp;
    </legend>

	<p><asp:Localize ID="Localize1" runat="server" Text="Web publishing enables your customers to publish content to their web sites through Web Deployment publishing protocol that is supported in modern web development tools such as Web Matrix and Visual Studio .NET 2010." /></p>
    <table width="100%" cellpadding="4">
		<tr>
