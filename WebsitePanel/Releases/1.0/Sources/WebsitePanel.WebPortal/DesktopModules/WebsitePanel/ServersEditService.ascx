<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServersEditService.ascx.cs" Inherits="WebsitePanel.Portal.ServersEditService" %>
<%@ Register Src="GlobalDnsRecordsControl.ascx" TagName="GlobalDnsRecordsControl" TagPrefix="wsp" %>
...
<div class="FormBody">
    ...
    <table cellSpacing="0" cellPadding="2" width="100%">
        ...
        <tr>
            ...
            <td><asp:textbox id="txtServiceName" runat="server" CssClass="HugeTextBox" Width="200px" MaxLength="50"></asp:textbox><asp:requiredfieldvalidator id="vldServiceNameRequired" runat="server" CssClass="NormalBold" ErrorMessage="Please enter service name"
		            ControlToValidate="txtServiceName" Display="Dynamic"></asp:requiredfieldvalidator></td>
        </tr>
        <tr>
            <td class="SubHead" vAlign="top"><asp:Label ID="lblComments" runat="server" meta:resourcekey="lblComments" Text="Comments:"></asp:Label>
            </td>
            <td class="Normal">
	            <asp:TextBox id="txtComments" runat="server" Width="200px" CssClass="NormalTextBox" TextMode="MultiLine"
		            Rows="3"></asp:TextBox>
            </td>
        </tr>
        <tr id="rowInstallResults" runat="server">
            <td class="NormalError" colspan="2">
                <asp:Label ID="lblServiceInstallationResults" runat="server" meta:resourcekey="lblServiceInstallationResults" Text="Service installation results:"></asp:Label>
    ...
    <wsp:CollapsiblePanel id="SettingsHeader" runat="server"
        TargetControlID="SettingsPanel" resourcekey="SettingsHeader" Text="Service Settings">
    ...
    <wsp:CollapsiblePanel id="DnsRecrodsHeader" runat="server"
        TargetControlID="DnsRecrodsPanel" resourcekey="DnsRecrodsHeader" Text="DNS Records Template">
    </wsp:CollapsiblePanel>
    <asp:Panel ID="DnsRecrodsPanel" runat="server">
    <table width="450px">
        <tr>
            <td>
                <wsp:GlobalDnsRecordsControl ID="GlobalDnsRecordsControl" runat="server"
                    IPServerIDParam="ServerID" ServiceIdParam="ServiceID" />
            </td>
        </tr>
    </table>
    </asp:Panel>
    ...
    <table id="tblCluster" runat="server" visible="false" width="100%">
        <tr>
            ...
            <td width="100%" class="Normal">
                <asp:DropDownList ID="ddlClusters" runat="server" Width="200px" CssClass="NormalTextBox" DataTextField="ClusterName" DataValueField="ClusterID">
                </asp:DropDownList>
                ...
                <asp:LinkButton ID="cmdDeleteCluster" runat="server" ValidationGroup="SelectCluster" OnClick="cmdDeleteCluster_Click">Delete Cluster</asp:LinkButton></td>
        </tr>
        <tr>
            <td class="SubHead">
            ...
            <td class="Normal">
                ...
                <asp:LinkButton ID="cmdAddCluster" runat="server" ValidationGroup="NewCluster" OnClick="cmdAddCluster_Click">Add Cluster</asp:LinkButton></td>
...
<div class="FormFooter">
    <asp:Button ID="btnUpdate" runat="server" meta:resourcekey="btnUpdate" CssClass="Button1" Text="Update" OnClick="btnUpdate_Click" OnClientClick="ShowProgressDialog('Updating Service...');"/>
    ...
    <asp:Button ID="btnDelete" runat="server" meta:resourcekey="btnDelete" CssClass="Button1" Text="Delete" CausesValidation="False" OnClick="btnDelete_Click" OnClientClick="return confirmation();" />
</div>