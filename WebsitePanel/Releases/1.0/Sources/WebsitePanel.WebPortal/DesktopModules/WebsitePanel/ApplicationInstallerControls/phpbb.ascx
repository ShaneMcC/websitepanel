...
<table cellPadding="2" width="100%">
	...
	<tr>
		<td></td>
		<td class="Normal">
			Several instances of phpBB can work with the same database simultaneously. 
			...
			So, if you install your first instance of phpBB on the selected database, 
			leave this field blank; otherwise, specify some value, for example 'phpBB'.
		</td>
	</tr>
	<tr>
		<td class=SubHead colspan=2>
			Enter the username and password you would like to use for the administrator account
			of your new phpBB site:
		</td>
	</tr>
	<tr>
