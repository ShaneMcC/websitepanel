<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterStats_EditSite.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterStats_EditSite" %>
<table width="100%" cellpadding="3" border="0">
    <tr>
        ...
        <td class="NormalBold" width="100%">
            <asp:TextBox id="txtSiteId" runat="server" CssClass="NormalTextBox" ReadOnly="true"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="SubHead">
