<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail60_EditDomain_Sharing.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail60_EditDomain_Sharing" %>
<table width="100%">
    <tr>
