<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail50_EditDomain_Sharing.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail50_EditDomain_Sharing" %>
<table width="100%">
    <tr>
