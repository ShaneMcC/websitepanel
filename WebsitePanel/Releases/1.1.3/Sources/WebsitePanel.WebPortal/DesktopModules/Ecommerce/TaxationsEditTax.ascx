<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaxationsEditTax.ascx.cs" Inherits="WebsitePanel.Ecommerce.Portal.TaxationsEditTax" %>
...
<div class="FormBody">
	<table cellspacing="0" cellpadding="3">
		...
		<tr>
			...
			<td>
				<asp:DropDownList runat="server" ID="ddlTaxType" CssClass="NormalTextBox" OnSelectedIndexChanged="ddlTaxType_SelectedIndexChanged">
		...
		<tr>
			...
			<td>
				...
				<asp:RequiredFieldValidator runat="server" ControlToValidate="txtTaxAmount" 
					Display="Dynamic" Text="*" meta:resourcekey="RequiredFieldValidator" />
...
<div class="FormFooter">
	<asp:Button runat="server" ID="btnSaveTax" meta:resourcekey="btnSaveTax" CssClass="Button1" 
		OnClick="btnSaveTax_Click" />&nbsp;
	<asp:Button runat="server" ID="btnDeleteTax" meta:resourcekey="btnDeleteTax" CssClass="Button1" 
		OnClick="btnDeleteTax_Click" CausesValidation="false" />&nbsp;
