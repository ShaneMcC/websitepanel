<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail50_EditAccount.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail50_EditAccount" %>
