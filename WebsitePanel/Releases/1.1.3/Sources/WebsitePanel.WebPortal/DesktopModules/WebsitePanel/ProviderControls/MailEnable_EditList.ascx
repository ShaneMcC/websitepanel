<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MailEnable_EditList.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.MailEnable_EditList" %>
...
<table cellSpacing="0" cellPadding="3" width="100%">
	...
	<tr>
		...
		<td class="normal">
			<asp:DropDownList id="ddlReplyTo" runat="server" resourcekey="ddlReplyTo" CssClass="NormalTextBox" Width="150px">
	...
	<tr>
		...
		<td class="normal">
			<asp:DropDownList id="ddlPostingMode" runat="server" 
                resourcekey="ddlPostingMode" CssClass="NormalTextBox" Width="210px" 
                Height="22px">
	...
	<tr>
		...
		<td class="normal">
			<asp:TextBox id="txtPassword" runat="server" CssClass="NormalTextBox"  TextMode="Password" Width="150px"></asp:TextBox>
		</td>
	</tr>
	<tr>
		<td class="SubHead">
		...
		<td class="normal">
			<asp:DropDownList id="ddlPrefixOption" runat="server" 
                resourcekey="ddlPrefixOption" CssClass="NormalTextBox" Width="210px">
...
<wsp:collapsiblepanel id="HeaderFooterSection" runat="server" targetcontrolid="pHeaderFooter"
    meta:resourcekey="HeaderFooterSection" ></wsp:collapsiblepanel>
