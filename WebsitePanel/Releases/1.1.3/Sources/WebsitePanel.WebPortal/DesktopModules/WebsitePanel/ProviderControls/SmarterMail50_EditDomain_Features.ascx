<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail50_EditDomain_Features.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail50_EditDomain_Features" %>
<table width="100%">
    <tr>
