<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail50_EditGroup.ascx.cs" Inherits="WebsitePanel.Portal.ProviderControls.SmarterMail50_EditGroup" %>
