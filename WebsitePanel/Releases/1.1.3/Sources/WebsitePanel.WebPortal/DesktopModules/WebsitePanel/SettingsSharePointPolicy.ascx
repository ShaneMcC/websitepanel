<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SettingsSharePointPolicy.ascx.cs" Inherits="WebsitePanel.Portal.SettingsSharePointPolicy" %>
...
<wsp:CollapsiblePanel id="secUsername" runat="server"
...
<wsp:CollapsiblePanel id="secGroup" runat="server"
