...
namespace WebsitePanel.Installer.Core
{
	internal sealed class AppConfigManager
	{
		...
		public const string AppConfigFileNameWithExtension = "WebsitePanel.Installer.exe.config";
		...
		public static void LoadConfiguration()
		{
			...
			appConfig = ConfigurationManager.OpenExeConfiguration(AppConfigFileNameWithExtension);
			//
